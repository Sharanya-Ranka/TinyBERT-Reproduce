...
from .file_utils import WEIGHTS_NAME, CONFIG_NAME, WEIGHTS_NAME1

logger = logging.getLogger(__name__)

# pretrained models inventory
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *inputs, **kwargs):
        ...
        if state_dict is None and not from_tf:
            try:
                ...
                logger.error(str(e))
                logger.info("Attempting to load safetensors file")
                weights_path = os.path.join(
                    pretrained_model_name_or_path, WEIGHTS_NAME1
                )
                logger.info("Loading model {}".format(weights_path))
